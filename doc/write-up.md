...
#. Выбираем случайное множество точек
#. Разбиваем все подземелье на кластера по принципу близости к выбранным точкам
#. Дальше на этих локальных частях запускаем алгоритм обхода (???)
#. Глобально части тоже как-нибудь обходим (???)
#. Profit!
